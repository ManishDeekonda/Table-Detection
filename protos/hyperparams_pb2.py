...
# source: Project/protos/hyperparams.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='Project/protos/hyperparams.proto',
  package='Project.protos',
  syntax='proto2',
  serialized_pb=_b('\n Project/protos/hyperparams.proto\x12\x0eProject.protos\"\xff\x02\n\x0bHyperparams\x12\x30\n\x02op\x18\x01 \x01(\x0e\x32\x1e.Project.protos.Hyperparams.Op:\x04\x43ONV\x12\x30\n\x0bregularizer\x18\x02 \x01(\x0b\x32\x1b.Project.protos.Regularizer\x12\x30\n\x0binitializer\x18\x03 \x01(\x0b\x32\x1b.Project.protos.Initializer\x12@\n\nactivation\x18\x04 \x01(\x0e\x32&.Project.protos.Hyperparams.Activation:\x04RELU\x12-\n\nbatch_norm\x18\x05 \x01(\x0b\x32\x19.Project.protos.BatchNorm\x12#\n\x14regularize_depthwise\x18\x06 \x01(\x08:\x05\x66\x61lse\"\x16\n\x02Op\x12\x08\n\x04\x43ONV\x10\x01\x12\x06\n\x02\x46\x43\x10\x02\",\n\nActivation\x12\x08\n\x04NONE\x10\x00\x12\x08\n\x04RELU\x10\x01\x12\n\n\x06RELU_6\x10\x02\"\x94\x01\n\x0bRegularizer\x12\x37\n\x0el1_regularizer\x18\x01 \x01(\x0b\x32\x1d.Project.protos.L1RegularizerH\x00\x12\x37\n\x0el2_regularizer\x18\x02 \x01(\x0b\x32\x1d.Project.protos.L2RegularizerH\x00\x42\x13\n\x11regularizer_oneof\"\"\n\rL1Regularizer\x12\x11\n\x06weight\x18\x01 \x01(\x02:\x01\x31\"\"\n\rL2Regularizer\x12\x11\n\x06weight\x18\x01 \x01(\x02:\x01\x31\"\x98\x02\n\x0bInitializer\x12R\n\x1ctruncated_normal_initializer\x18\x01 \x01(\x0b\x32*.Project.protos.TruncatedNormalInitializerH\x00\x12R\n\x1cvariance_scaling_initializer\x18\x02 \x01(\x0b\x32*.Project.protos.VarianceScalingInitializerH\x00\x12L\n\x19random_normal_initializer\x18\x03 \x01(\x0b\x32\'.Project.protos.RandomNormalInitializerH\x00\x42\x13\n\x11initializer_oneof\"@\n\x1aTruncatedNormalInitializer\x12\x0f\n\x04mean\x18\x01 \x01(\x02:\x01\x30\x12\x11\n\x06stddev\x18\x02 \x01(\x02:\x01\x31\"\xbc\x01\n\x1aVarianceScalingInitializer\x12\x11\n\x06\x66\x61\x63tor\x18\x01 \x01(\x02:\x01\x32\x12\x16\n\x07uniform\x18\x02 \x01(\x08:\x05\x66\x61lse\x12\x45\n\x04mode\x18\x03 \x01(\x0e\x32/.Project.protos.VarianceScalingInitializer.Mode:\x06\x46\x41N_IN\",\n\x04Mode\x12\n\n\x06\x46\x41N_IN\x10\x00\x12\x0b\n\x07\x46\x41N_OUT\x10\x01\x12\x0b\n\x07\x46\x41N_AVG\x10\x02\"=\n\x17RandomNormalInitializer\x12\x0f\n\x04mean\x18\x01 \x01(\x02:\x01\x30\x12\x11\n\x06stddev\x18\x02 \x01(\x02:\x01\x31\"z\n\tBatchNorm\x12\x14\n\x05\x64\x65\x63\x61y\x18\x01 \x01(\x02:\x05\x30.999\x12\x14\n\x06\x63\x65nter\x18\x02 \x01(\x08:\x04true\x12\x14\n\x05scale\x18\x03 \x01(\x08:\x05\x66\x61lse\x12\x16\n\x07\x65psilon\x18\x04 \x01(\x02:\x05\x30.001\x12\x13\n\x05train\x18\x05 \x01(\x08:\x04true')
)
...
_HYPERPARAMS_OP = _descriptor.EnumDescriptor(
  name='Op',
  full_name='Project.protos.Hyperparams.Op',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HYPERPARAMS_ACTIVATION = _descriptor.EnumDescriptor(
  name='Activation',
  full_name='Project.protos.Hyperparams.Activation',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_VARIANCESCALINGINITIALIZER_MODE = _descriptor.EnumDescriptor(
  name='Mode',
  full_name='Project.protos.VarianceScalingInitializer.Mode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_HYPERPARAMS = _descriptor.Descriptor(
  name='Hyperparams',
  full_name='Project.protos.Hyperparams',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='op', full_name='Project.protos.Hyperparams.op', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='regularizer', full_name='Project.protos.Hyperparams.regularizer', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='initializer', full_name='Project.protos.Hyperparams.initializer', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='activation', full_name='Project.protos.Hyperparams.activation', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_norm', full_name='Project.protos.Hyperparams.batch_norm', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='regularize_depthwise', full_name='Project.protos.Hyperparams.regularize_depthwise', index=5,
...
_REGULARIZER = _descriptor.Descriptor(
  name='Regularizer',
  full_name='Project.protos.Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='l1_regularizer', full_name='Project.protos.Regularizer.l1_regularizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='l2_regularizer', full_name='Project.protos.Regularizer.l2_regularizer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='regularizer_oneof', full_name='Project.protos.Regularizer.regularizer_oneof',
...
_L1REGULARIZER = _descriptor.Descriptor(
  name='L1Regularizer',
  full_name='Project.protos.L1Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='Project.protos.L1Regularizer.weight', index=0,
...
_L2REGULARIZER = _descriptor.Descriptor(
  name='L2Regularizer',
  full_name='Project.protos.L2Regularizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weight', full_name='Project.protos.L2Regularizer.weight', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZER = _descriptor.Descriptor(
  name='Initializer',
  full_name='Project.protos.Initializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='truncated_normal_initializer', full_name='Project.protos.Initializer.truncated_normal_initializer', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='variance_scaling_initializer', full_name='Project.protos.Initializer.variance_scaling_initializer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='random_normal_initializer', full_name='Project.protos.Initializer.random_normal_initializer', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='initializer_oneof', full_name='Project.protos.Initializer.initializer_oneof',
      index=0, containing_type=None, fields=[]),
  ],
...
_TRUNCATEDNORMALINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='Project.protos.TruncatedNormalInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mean', full_name='Project.protos.TruncatedNormalInitializer.mean', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='stddev', full_name='Project.protos.TruncatedNormalInitializer.stddev', index=1,
...
_VARIANCESCALINGINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='Project.protos.VarianceScalingInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='factor', full_name='Project.protos.VarianceScalingInitializer.factor', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uniform', full_name='Project.protos.VarianceScalingInitializer.uniform', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mode', full_name='Project.protos.VarianceScalingInitializer.mode', index=2,
...
_RANDOMNORMALINITIALIZER = _descriptor.Descriptor(
  ...
  full_name='Project.protos.RandomNormalInitializer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='mean', full_name='Project.protos.RandomNormalInitializer.mean', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='stddev', full_name='Project.protos.RandomNormalInitializer.stddev', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BATCHNORM = _descriptor.Descriptor(
  name='BatchNorm',
  full_name='Project.protos.BatchNorm',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='decay', full_name='Project.protos.BatchNorm.decay', index=0,
      number=1, type=2, cpp_type=6, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='center', full_name='Project.protos.BatchNorm.center', index=1,
      number=2, type=8, cpp_type=7, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='scale', full_name='Project.protos.BatchNorm.scale', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='epsilon', full_name='Project.protos.BatchNorm.epsilon', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='train', full_name='Project.protos.BatchNorm.train', index=4,
...
Hyperparams = _reflection.GeneratedProtocolMessageType('Hyperparams', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.Hyperparams)
  ))
...
Regularizer = _reflection.GeneratedProtocolMessageType('Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.Regularizer)
  ))
...
L1Regularizer = _reflection.GeneratedProtocolMessageType('L1Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.L1Regularizer)
  ))
...
L2Regularizer = _reflection.GeneratedProtocolMessageType('L2Regularizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.L2Regularizer)
  ))
...
Initializer = _reflection.GeneratedProtocolMessageType('Initializer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.Initializer)
  ))
...
TruncatedNormalInitializer = _reflection.GeneratedProtocolMessageType('TruncatedNormalInitializer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.TruncatedNormalInitializer)
  ))
...
VarianceScalingInitializer = _reflection.GeneratedProtocolMessageType('VarianceScalingInitializer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.VarianceScalingInitializer)
  ))
...
RandomNormalInitializer = _reflection.GeneratedProtocolMessageType('RandomNormalInitializer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.RandomNormalInitializer)
  ))
...
BatchNorm = _reflection.GeneratedProtocolMessageType('BatchNorm', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.hyperparams_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.BatchNorm)
  ))
