...
# source: Project/protos/image_resizer.proto
...
_IMAGERESIZER = _descriptor.Descriptor(
  name='ImageResizer',
  full_name='Project.protos.ImageResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keep_aspect_ratio_resizer', full_name='Project.protos.ImageResizer.keep_aspect_ratio_resizer', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fixed_shape_resizer', full_name='Project.protos.ImageResizer.fixed_shape_resizer', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='image_resizer_oneof', full_name='Project.protos.ImageResizer.image_resizer_oneof',
...
_KEEPASPECTRATIORESIZER = _descriptor.Descriptor(
  ...
  full_name='Project.protos.KeepAspectRatioResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_dimension', full_name='Project.protos.KeepAspectRatioResizer.min_dimension', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_dimension', full_name='Project.protos.KeepAspectRatioResizer.max_dimension', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='resize_method', full_name='Project.protos.KeepAspectRatioResizer.resize_method', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pad_to_max_dimension', full_name='Project.protos.KeepAspectRatioResizer.pad_to_max_dimension', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='convert_to_grayscale', full_name='Project.protos.KeepAspectRatioResizer.convert_to_grayscale', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='per_channel_pad_value', full_name='Project.protos.KeepAspectRatioResizer.per_channel_pad_value', index=5,
...
_FIXEDSHAPERESIZER = _descriptor.Descriptor(
  ...
  full_name='Project.protos.FixedShapeResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='Project.protos.FixedShapeResizer.height', index=0,
      number=1, type=5, cpp_type=1, label=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='width', full_name='Project.protos.FixedShapeResizer.width', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=300,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='resize_method', full_name='Project.protos.FixedShapeResizer.resize_method', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='convert_to_grayscale', full_name='Project.protos.FixedShapeResizer.convert_to_grayscale', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ImageResizer = _reflection.GeneratedProtocolMessageType('ImageResizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.ImageResizer)
  ))
...
KeepAspectRatioResizer = _reflection.GeneratedProtocolMessageType('KeepAspectRatioResizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.KeepAspectRatioResizer)
  ))
...
FixedShapeResizer = _reflection.GeneratedProtocolMessageType('FixedShapeResizer', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.FixedShapeResizer)
  ))
