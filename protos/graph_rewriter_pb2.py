...
# source: Project/protos/graph_rewriter.proto
...
_GRAPHREWRITER = _descriptor.Descriptor(
  name='GraphRewriter',
  full_name='Project.protos.GraphRewriter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='quantization', full_name='Project.protos.GraphRewriter.quantization', index=0,
...
_QUANTIZATION = _descriptor.Descriptor(
  name='Quantization',
  full_name='Project.protos.Quantization',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='delay', full_name='Project.protos.Quantization.delay', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weight_bits', full_name='Project.protos.Quantization.weight_bits', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='activation_bits', full_name='Project.protos.Quantization.activation_bits', index=2,
...
GraphRewriter = _reflection.GeneratedProtocolMessageType('GraphRewriter', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.graph_rewriter_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.GraphRewriter)
  ))
...
Quantization = _reflection.GeneratedProtocolMessageType('Quantization', (_message.Message,), dict(
  ...
  __module__ = 'Project.protos.graph_rewriter_pb2'
  # @@protoc_insertion_point(class_scope:Project.protos.Quantization)
  ))
